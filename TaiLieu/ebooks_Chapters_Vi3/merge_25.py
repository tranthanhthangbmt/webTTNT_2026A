...
def merge_html_parts(input_dir, output_file, num_parts):
    with open(output_file, 'w', encoding='utf-8') as outfile:
        for i in range(1, num_parts + 1):
            part_file = os.path.join(input_dir, f'part{i}_25.html')
...
if __name__ == "__main__":
    input_directory = "Chapter_25_Deep learning for natural language processing"
    output_filename = "chapter_25_vi.html"
    output_path = os.path.join(input_directory, output_filename)
    merge_html_parts(input_directory, output_path, 9)
